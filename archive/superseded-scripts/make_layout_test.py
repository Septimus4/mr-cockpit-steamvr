...
LAYOUT={}
cv2.putText(page,"ROW  (ids 35-37)  lateral 80mm, vertical 22mm",(mm(20),mm(30)),
            cv2.FONT_HERSHEY_SIMPLEX,0.8,0,2)
for k,mid in enumerate((35,36,37)):
    LAYOUT[mid]=put(mid, 60+k*(SPAN/2), 60)

cv2.putText(page,"SQUARE  (ids 44-47)  lateral 80mm, vertical 80mm",(mm(20),mm(150)),
            cv2.FONT_HERSHEY_SIMPLEX,0.8,0,2)
for mid,(dx,dy) in zip((44,45,46,47),((0,0),(SPAN,0),(SPAN,SPAN),(0,SPAN))):
    LAYOUT[mid]=put(mid, 60+dx, 180+dy)
...
cv2.imwrite("PRINT-THESE/screen-layout-test.png",page)
np.savez("archive/layout_geometry.npz",
